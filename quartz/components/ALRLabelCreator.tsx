          ...
          <div class="alr-lc-body">
            ...
            <div class="alr-lc-left">
              ...
              <div class="alr-lc-color-row">
                ...
                <div class="alr-lc-field">
                  <div class="alr-lc-label">Grade Colour</div>
                  <div class="alr-lc-color-wrap"><input type="color" id="alr-lc-cgrd" value="#cc785c" /><input class="alr-lc-hex" id="alr-lc-hgrd" value="#cc785c" /></div>
                </div>
              </div>
              <div class="alr-lc-color-row">
                <div class="alr-lc-field">
...
(function() {
  ...
  function buildFold(v) {
    ...
    return '<svg width="70mm" height="40.6mm" viewBox="0 0 700 406" xmlns="http://www.w3.org/2000/svg">'
      ...
      +'<g transform="translate(700,406) rotate(180)"><svg width="700" height="200" viewBox="0 0 700 200">'+b+'</svg></g>'
  ...
  function render() {
    ...
    if (tab === 'fold') {
      ...
      var lbl = tab === 'front' ? 'Front' : 'Back (rotated when printed)';
      el.innerHTML = '<div class="alr-lc-plabel">'+lbl+'</div><div class="alr-lc-svgwrap">'+svg+'</div>';
    }
  }
  ...
  function setPreset(name) {
    ...
    function setc(cid, hid, v) {
      var c=g(cid), h=g(hid);
      if(c) c.value=v; if(h) h.value=v;
    }
    setc('alr-lc-cbody','alr-lc-hbody',p.body);
    setc('alr-lc-czone','alr-lc-hzone',p.zone);
    setc('alr-lc-cacc','alr-lc-hacc',p.acc);
    setc('alr-lc-cgrd','alr-lc-hgrd',p.grd);
    setc('alr-lc-ctxt','alr-lc-htxt',p.txt);
    setc('alr-lc-cmut','alr-lc-hmut',p.mut);
    render();
  }
  ...
  function bindColorPair(cid, hid) {
    var c = g(cid), h = g(hid);
  ...
  function init() {
    ...
    bindColorPair('alr-lc-cbody','alr-lc-hbody');
    bindColorPair('alr-lc-czone','alr-lc-hzone');
    bindColorPair('alr-lc-cacc','alr-lc-hacc');
    bindColorPair('alr-lc-cgrd','alr-lc-hgrd');
    bindColorPair('alr-lc-ctxt','alr-lc-htxt');
    bindColorPair('alr-lc-cmut','alr-lc-hmut');
  ...
  document.addEventListener('nav', init);
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .alr-lc-header { margin-bottom: 2rem; }
        .alr-lc-sub { color: var(--gray); font-size: 0.95rem; margin-top: 0.5rem; }
        ...
        .alr-lc-body { display: grid; grid-template-columns: 280px 1fr; min-height: 480px; }
        .alr-lc-left { border-right: 1px solid var(--lightgray); padding: 14px; display: flex; flex-direction: column; gap: 8px; overflow-y: auto; max-height: 560px; }
        ...
        .alr-lc-preset-btn { flex: 1; font-family: var(--codeFont), monospace; font-size: 10px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; padding: 7px 0; border-radius: 3px; cursor: pointer; border: 1px solid var(--lightgray); background: transparent; color: var(--gray); transition: all 0.15s; }
        .alr-lc-preset-btn:hover { border-color: #cc785c; color: #cc785c; }
        .alr-lc-preset-active { border-color: #cc785c !important; color: #cc785c !important; background: rgba(204,120,92,0.08) !important; }
        .alr-lc-tabs { display: flex; border-bottom: 1px solid var(--lightgray); }
        .alr-lc-tab { font-family: var(--codeFont), monospace; font-size: 9px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; padding: 8px 14px; cursor: pointer; color: var(--gray); background: none; border: none; border-bottom: 2px solid transparent; transition: all 0.15s; }
        ...
        .alr-lc-btn-primary { font-family: var(--codeFont), monospace; font-size: 10px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; padding: 7px 12px; border-radius: 3px; cursor: pointer; background: #cc785c; border: 1px solid #cc785c; color: #fff; transition: all 0.15s; }
        .alr-lc-btn-primary:hover { background: #b86848; border-color: #b86848; }
        .alr-lc-btn-ghost { font-family: var(--codeFont), monospace; font-size: 10px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; padding: 7px 12px; border-radius: 3px; cursor: pointer; background: transparent; border: 1px solid var(--lightgray); color: var(--gray); transition: all 0.15s; }
        ...
        @media (max-width: 700px) {
          .alr-lc-body { grid-template-columns: 1fr; }
          .alr-lc-left { border-right: none; border-bottom: 1px solid var(--lightgray); max-height: none; }
        }
      ` }} />
