...
const ALRBanner: QuartzComponent = (_props: QuartzComponentProps) => {
  return (
    <div class="alr-banner-wrap">
      ...
      <div class="alr-banner-subtitle">
        <span class="alr-banner-subtitle-main">What remains when a reality stops?</span>
        <span class="alr-banner-subtitle-ghost alr-banner-subtitle-ghost-a">
          What remains when a reality stops?
        </span>
        <span class="alr-banner-subtitle-ghost alr-banner-subtitle-ghost-b">
          What remains when a reality stops?
        </span>
      </div>
    </div>
