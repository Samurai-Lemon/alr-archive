...
const ALRBanner: QuartzComponent = (_props: QuartzComponentProps) => {
  return (
    <svg width="100%" viewBox="0 0 680 120" xmlns="http://www.w3.org/2000/svg" style="display:block;margin-bottom:20px;">
      <defs>
        <clipPath id="bc2"><rect x="0" y="0" width="680" height="120"/></clipPath>
      </defs>
      <g clip-path="url(#bc2)">
        <rect x="0" y="0" width="680" height="120" fill="#0f0e0b"/>
        ...
        <line x1="68" y1="0" x2="68" y2="120" stroke="#cc785c" stroke-width="0.3" opacity="0.15"/>
        <line x1="136" y1="0" x2="136" y2="120" stroke="#cc785c" stroke-width="0.3" opacity="0.15"/>
        <line x1="204" y1="0" x2="204" y2="120" stroke="#cc785c" stroke-width="0.3" opacity="0.15"/>
        <line x1="272" y1="0" x2="272" y2="120" stroke="#cc785c" stroke-width="0.3" opacity="0.15"/>
        <line x1="340" y1="0" x2="340" y2="120" stroke="#cc785c" stroke-width="0.3" opacity="0.15"/>
        <line x1="408" y1="0" x2="408" y2="120" stroke="#cc785c" stroke-width="0.3" opacity="0.15"/>
        <line x1="476" y1="0" x2="476" y2="120" stroke="#cc785c" stroke-width="0.3" opacity="0.15"/>
        <line x1="544" y1="0" x2="544" y2="120" stroke="#cc785c" stroke-width="0.3" opacity="0.15"/>
        <line x1="612" y1="0" x2="612" y2="120" stroke="#cc785c" stroke-width="0.3" opacity="0.15"/>
        <rect x="2" y="2" width="64" height="26" fill="#cc785c" opacity="0.06"/>
        ...
        <rect x="70" y="92" width="64" height="26" fill="#cc785c" opacity="0.05"/>
        <rect x="206" y="2" width="64" height="26" fill="#cc785c" opacity="0.04"/>
        <rect x="206" y="32" width="30" height="26" fill="#cc785c" opacity="0.03"/>
        <rect x="274" y="2" width="20" height="26" fill="#cc785c" opacity="0.02"/>
        <rect x="274" y="62" width="40" height="26" fill="#cc785c" opacity="0.02"/>
        ...
        <line x1="320" y1="0" x2="330" y2="120" stroke="#cc785c" stroke-width="0.8" opacity="0.4" stroke-dasharray="6 4"/>
        <g transform="translate(483, -18) scale(0.354)" opacity="0.18">
