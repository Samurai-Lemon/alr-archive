  ...
  return (
    ...
    >
      ...
      <g clip-path="url(#ordo-bc)">
        ...
        <text x="340" y="108" font-family="'IM Fell English', serif" font-size="36" font-weight="400" fill="#ede0c8" letter-spacing="1" text-anchor="middle" opacity="0.95">Memoria Damnatio</text>
