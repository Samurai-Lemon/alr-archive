  ...
  return (
    <>
      <div class="alr-home">
        ...
        {/* ── HERO — banner SVG as background with overlay content ── */}
        <div class="alr-home-hero-wrap">
          ...
          >
            ...
            {/* ALR logo watermark */}
            <g transform="translate(483, 10) scale(0.4)" opacity="0.12">
              <path
            ...
            {/* fade-out at bottom so content below blends */}
            <rect x="0" y="190" width="680" height="30" fill="#0f0e0b" opacity="0.5" />
          </svg>

          {/* overlay: title left, status cards right */}
        ...
        <div class="alr-home-featured">
          <div class="alr-home-featured-left">
            ...
            <div class="alr-home-featured-tags">
              ...
              <span class="alr-etag alr-et-unknown">RCC Unknown</span>
            </div>
        ...
        {/* ── MAIN GRID: echoes left, realities + notices right ── */}
        <div class="alr-grid">
          <RecentEchoes {...props} />
