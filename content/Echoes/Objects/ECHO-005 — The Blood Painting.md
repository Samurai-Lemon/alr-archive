...
> [!warning] Personnel Advisory — Mandatory Restriction
...
> ECHO-005 was formally registered and assigned Terminal classification following the correlation of casualty reports across three separate investigated realities in which an identical object was described. All photographic documentation of the painting is stored under restricted access within [[The Archive]]. Photographic records are not available to personnel below Senior Researcher or Lead Investigator grade. A small number of personnel who reviewed photographic documentation during the initial registration process reported mild intrusive effects following exposure to the images. Photographic documentation of ECHO-005 is now handled exclusively through indirect review protocols. No physical samples of the medium have been recovered. The biological source of the blood has not been identified. This line of inquiry remains open.

> [!note]- Investigator Note — Lead Investigator R. Hayle, Reality Investigation Division
> I did not look at it directly. I knew better going in, and I maintained that. But I caught the edge of it in my peripheral vision when I turned to leave the room — just the corner, just for a moment, less than a second by any reasonable estimate. That was three weeks ago. I have submitted all required evaluation forms. I have been cleared for continued operations. I want both of those things noted clearly in the record. I also want it noted that I still think about what I saw in that corner. Not constantly. Not in a way that impairs function. But it is there. Whatever was happening in that corner of the painting, it has not finished happening in my memory. I do not know how else to describe it. I am fine.
