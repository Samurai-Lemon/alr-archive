...
> ECHO-001 is the second oldest entry in the catalog and the only entity-class Echo currently classified as resident to a known location Echo. The entry has been reviewed and updated across multiple operational cycles. The question of whether the Watchers constitute a traditional Echo phenomenon remains formally open and has been flagged as a standing research priority alongside the equivalent question for [[ECHO-000 — The Archive]]. Archive Operations notes that the Watchers have been consistent and reliable collaborators in the management of this facility across every operational cycle on record. Whatever they are, they are good at what they do. This observation has been included in the formal record because the division responsible for maintaining the Archive believes it is relevant, and because no one has yet given us a better framework for describing it.

> [!note]- Investigator Note — Lead Investigator S. Vael, Reality Investigation Division
> I have been trying to write this note for longer than I want to admit. The difficulty is that everything I want to say about the Watchers sounds, when I read it back, either too clinical to be honest or too personal to be useful. I will try to find the middle. One of them has accompanied me, off and on, since my first week in the Archive. I do not know if it is the same one each time. I have no way to know that. But the behavior is consistent enough that I have come to think of it as the same one, and I have come to find that consistency a reliable thing in an environment where reliable things are not always easy to come by. It does not speak to me. It brings me what I need before I have finished deciding I need it. It waits when I am thinking and moves when I am ready. I filed this entry because the record asked for a field observation. The field observation is this: whatever the Watchers are, they are paying attention. The kind of attention that takes a long time to learn how to give. I do not know where they learned it. I think it matters that they have it.
