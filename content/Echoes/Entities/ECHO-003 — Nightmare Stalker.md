...
> ECHO-003 was formally registered following cross-referencing of encounter reports collected across four realities in which a presence matching this description was documented. Registration occurred in the same operational cycle as [[ECHO-002 — Dreamwalker]], and the two entries have been maintained as a linked pair within [[The Archive]] since initial filing. All psychological evaluation records associated with ECHO-003 encounter reports are stored under restricted access. Two case files from incidents involving repeated exposure have been sealed pending [[Echo Research Division]] review. Access requests must be directed through divisional channels. The origin reality of ECHO-003 has not been identified. This inquiry has been escalated to Senior Researcher grade. It has remained open for longer than escalated inquiries typically remain open. No explanation for this has been formally recorded.

> [!note]- Investigator Note — Lead Investigator E. Maren, Reality Investigation Division
> I have reviewed fourteen encounter reports for this entry. I have become increasingly uncomfortable with the language the witnesses use. They do not describe discovering the entity. They describe realizing it was already there. That distinction appears across fourteen accounts from investigators who had no access to one another's documentation, and I do not know what to do with it. The implication — if I follow it — is that the encounter does not begin when the entity appears. It begins when the observer finally notices it. I do not know how long the entity was present before that moment. I do not know if that question has a bounded answer. What I know is that fourteen people described the same realization in fourteen different ways, and none of them used the word arrived. I think that is the most important detail in this record. I think it has been there longer than we know.
