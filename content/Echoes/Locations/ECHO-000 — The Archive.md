...
> [!example] Documented Anomalous Properties
...
> ECHO-000 is the oldest entry in the catalog and the only Echo for which the standard classification framework has been formally flagged as potentially inapplicable. The entry has been reviewed and updated across multiple operational cycles as new observational data has accumulated. The current entry reflects the most complete account of the structure's documented properties available at the time of filing. The question of origin remains open and has been designated a standing research priority by the Echo Research Division since Operational Cycle 2. No material progress toward resolution has been recorded. The Archive Operations division notes, for the record, that conducting an investigation into the nature of the building you are standing in presents challenges that are not fully addressed by standard investigative methodology.

> [!note]- Investigator Note — Lead Investigator E. Maren, Reality Investigation Division
> I have worked inside this structure for longer than I have worked anywhere else. I know its corridors better than I know most places I have lived. I want to record something that does not appear in the formal observational data because it is not the kind of thing that appears in formal observational data. The Archive feels like it has been waiting. Not for us specifically — not for the Initiative, not for the work we do here. Longer than that. It feels like something that has been patient for a very long time and has found, in us, a use for that patience. I do not know if that is a meaningful observation or a projection. I have recorded it because I think the distinction between those two things may be less clear here than it is elsewhere, and that the record should reflect that uncertainty.
